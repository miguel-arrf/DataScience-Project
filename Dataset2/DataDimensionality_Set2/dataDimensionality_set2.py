...
savefig('../DataDimensionality_set2/images/records_variables.png')
...
savefig('../DataDimensionality_set2/images/variable_types.png')
show()
...
savefig('../DataDimensionality_set2/images/missing_values.png')
show()