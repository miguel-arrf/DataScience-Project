...
class KNN:
    def __init__(self, trnX, trnY, tstY, tstX, imagePath):
        ...
        plot_evaluation_results(["Safe", "Danger"], trnY, prd_trn, tstY, prd_tst, extra="KNN")
        ...
        for n in nvalues:
            ...
            y_tst_values_precision.append(precision_score(tstY, prd_tst_Y))
            y_trn_values_precision.append(precision_score(trnY, prd_trn_Y))

            y_tst_values_recall.append(recall_score(tstY, prd_tst_Y))
            y_trn_values_recall.append(recall_score(trnY, prd_trn_Y))
