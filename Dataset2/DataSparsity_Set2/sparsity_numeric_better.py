...
for i in range(len(numeric_vars)):
    ...
    for j in range(i + 1, len(numeric_vars)):
        ...
        seaborn.stripplot(y=data[var1].astype(str), x=data[var2].astype(str), jitter=0.35, edgecolor='gray', alpha=.25,
                          ax=axs[i, j - 1], palette=colors)
print("Saving figure")
savefig(f'../DataSparsity_Set2/images/sparsity_study_numeric_better.png')
# show()
print("Done")
