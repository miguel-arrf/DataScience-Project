...
plt.tight_layout()
savefig("images/Clustering_Hierarchical", dpi=300)
#show()
...
plot_line(N_CLUSTERS, sc, title='Hierarchical SC', xlabel='k', ylabel='SC', ax=ax[0, 1], percentage=False,
          yLimit=[-1, 1])
plt.tight_layout()
savefig("images/Hierarchical", dpi=300)
show()
...
for i in range(len(LINKS)):
    ...
    values_sc[m] = sc
plt.tight_layout()
savefig("images/MetricsHier", dpi=300)
show()
...
plt.tight_layout()
savefig("images/Metrics_Hierarchical", dpi=300)
show()
